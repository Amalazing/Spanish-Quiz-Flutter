...
class QuesitonText extends StatefulWidget {
  final String _question;
  final int _questionNumber;

  QuesitonText(this._question, this._questionNumber);

  @override
  State createState() => new QuestionTextState();
}

class QuestionTextState extends State<QuesitonText>
  ...
  @override
  void didUpdateWidget(QuesitonText oldWidget){
